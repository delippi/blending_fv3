...
variables = ["ugrd","vgrd","tmp","spfh","pressfc","delz"] #do we also want the sfc fields?
variables = ["ugrd"]
gvariables= ["u_s"]
...
if blend:
    ...
    pdb.set_trace()
    glb_nlon = glb_fg_nc.dimensions["grid_xt"].size  # 1799
    glb_nlat = glb_fg_nc.dimensions["grid_yt"].size  # 1059
    glb_nlev = glb_fg_nc.dimensions["pfull"].size    # pfull=65, fhalf=66
    glb_Dx = glb_fg_nc.dx / 1000.0
    ...
    nlon = reg_fg_nc.dimensions["grid_xt"].size
    nlat = reg_fg_nc.dimensions["grid_yt"].size
    nlev = reg_fg_nc.dimensions["pfull"].size
