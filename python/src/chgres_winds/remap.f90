 subroutine main(geolon_s,geolat_s,geolon_w,geolat_w,is,ie,js,je,u_s,v_s,u_w,v_w,ud,vd)
 use omp_lib
 use, intrinsic :: ieee_arithmetic
 implicit none
 real(kind=8), dimension(1820,1093),    intent(IN)    :: geolon_s,geolat_s
 real(kind=8), dimension(1820,1093,66), intent(IN)    :: u_s,v_s
 real(kind=8), dimension(1820,1093,66), intent(INOUT) :: ud
 real(kind=8), dimension(1821,1092),    intent(IN)    :: geolon_w,geolat_w
 real(kind=8), dimension(1821,1092,66), intent(IN)    :: u_w,v_w
 real(kind=8), dimension(1821,1092,66), intent(INOUT) :: vd
...
!$OMP             private(p1,p2,p3,e1,e2,ex,ey)
 ...
 return
   ...
   real(kind=8) function inner_prod(v1, v2)
