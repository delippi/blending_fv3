...
if [[ ${DO_ENSEMBLE}  == "TRUE" ]]; then
   ...
   ARCHIVEDIR="/NCEPDEV/emc-meso/5year/Donald.E.Lippi/blending/retro/rrfs_ens"
...
STMP="/lfs/h2/emc/stmp/donald.e.lippi/rrfs/July2022_retro/Ens_blending_${BLENDING_LENGTHSCALE}/${version}/ensda"
if [[ ${DO_ENSFCST} == "TRUE" ]] ; then
  STMP="/lfs/h2/emc/stmp/donald.e.lippi/rrfs/July2022_retro/Ens_blending_${BLENDING_LENGTHSCALE}/${version}/ensfcst"
fi
